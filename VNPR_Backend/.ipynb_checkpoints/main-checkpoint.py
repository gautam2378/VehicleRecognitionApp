...
# path = 'https://imgd-ct.aeplcdn.com/640X480/cw/ucp/stockApiImg/FGST8SL_2c851e41062243d8bc5df4665a5e5c28_1_31034321.jpg?q=80'
# path = 'https://thumbs.dreamstime.com/z/white-bmw-car-motion-asphalt-road-side-view-street-bucharest-romania-202471876.jpg?w=992'
# path = 'https://preview.redd.it/l711n5sj8se31.jpg?auto=webp&s=52b6b9ec915146832d22ca59b144a1bf190cc396'
# path = 'https://th.bing.com/th/id/R.92ce135d25e1923a18981d62fb88d651?rik=63AQS9Gbj9Thog&riu=http%3a%2f%2ffijisun.com.fj%2fwp-content%2fuploads%2f2016%2f04%2fcars-in-India-2-680x365.jpg&ehk=SX3SPjMAzeiFW%2fDZPvUcV4kb4Wb9ZwL8d9w3IZ5JdG4%3d&risl=&pid=ImgRaw&r=0'
# path = 'https://i.ytimg.com/vi/AWv1srC1YRQ/maxresdefault.jpg'
# path = 'https://www.wallpaperflare.com/static/116/409/313/bentley-flying-spur-w12-s-paris-auto-show-2016-luxury-cars-gray-wallpaper.jpg'
# path = './Videos/full.avi'
# path = './Videos/11.png'
# path = './Videos/test.mp4'
# path = 'https://images.hindustantimes.com/img/2022/09/01/1600x900/AR_AB_RENAULT_3_CAR_RANGE_03_1662026581176_1662026918534_1662047318982_1662047318982.JPG'
...
#                         if len(license_plates)!=0:
#                             x1,y1,x2,y2,score,class_id = license_plates[0]
#                             license_plate_crop = car[int(y1):int(y2), int(x1):int(x2),:]
#                             license_plate_crop = imutils.rotate(license_plate_crop, -30)
#                             thresh_img =test.preprocess_license_plate(license_plate_crop,is_visualize_steps=False)
#                             license_plate_text , _ = util.read_license_plate(thresh_img,reader)
#                             if license_plate_text and license_plate_text!="":
#                                 print("Predictions\n\n")
#                                 print(track_ids[i],license_plate_text)
#                                 if track_ids[i] in result:
#                                     if len(result[track_ids[i]])<8 and license_plate_text>=8 and len(result[track_ids[i]])>11:
#                                         temp = datetime.datetime.now().strftime("%H:%M:%S %B %d, %Y")
#                                         result[track_ids[i]] = [license_plate_text,temp]
#                                 else:
#                                     if len(license_plate_text)>=8:
#                                         temp  = datetime.datetime.now().strftime("%H:%M:%S %B %d, %Y")
#                                         result[track_ids[i]] = [license_plate_text,temp]
#             except:
#                 pass
